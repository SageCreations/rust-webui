...
pub const webui_browser_NoBrowser: webui_browser = 0;
pub const webui_browser_AnyBrowser: webui_browser = 1;
pub const webui_browser_Chrome: webui_browser = 2;
pub const webui_browser_Firefox: webui_browser = 3;
pub const webui_browser_Edge: webui_browser = 4;
pub const webui_browser_Safari: webui_browser = 5;
pub const webui_browser_Chromium: webui_browser = 6;
pub const webui_browser_Opera: webui_browser = 7;
pub const webui_browser_Brave: webui_browser = 8;
pub const webui_browser_Vivaldi: webui_browser = 9;
pub const webui_browser_Epic: webui_browser = 10;
pub const webui_browser_Yandex: webui_browser = 11;
pub const webui_browser_ChromiumBased: webui_browser = 12;
pub const webui_browser_Webview: webui_browser = 13;
pub type webui_browser = ::std::os::raw::c_uint;
pub const webui_runtime_None: webui_runtime = 0;
pub const webui_runtime_Deno: webui_runtime = 1;
pub const webui_runtime_NodeJS: webui_runtime = 2;
pub const webui_runtime_Bun: webui_runtime = 3;
pub type webui_runtime = ::std::os::raw::c_uint;
pub const webui_event_WEBUI_EVENT_DISCONNECTED: webui_event = 0;
pub const webui_event_WEBUI_EVENT_CONNECTED: webui_event = 1;
pub const webui_event_WEBUI_EVENT_MOUSE_CLICK: webui_event = 2;
pub const webui_event_WEBUI_EVENT_NAVIGATION: webui_event = 3;
pub const webui_event_WEBUI_EVENT_CALLBACK: webui_event = 4;
pub type webui_event = ::std::os::raw::c_uint;
pub const webui_config_show_wait_connection: webui_config = 0;
pub const webui_config_ui_event_blocking: webui_config = 1;
pub const webui_config_folder_monitor: webui_config = 2;
pub const webui_config_multi_client: webui_config = 3;
pub const webui_config_use_cookies: webui_config = 4;
pub const webui_config_asynchronous_response: webui_config = 5;
pub type webui_config = ::std::os::raw::c_uint;
#[repr(C)]
...
pub const webui_logger_level_WEBUI_LOGGER_LEVEL_DEBUG: webui_logger_level = 0;
pub const webui_logger_level_WEBUI_LOGGER_LEVEL_INFO: webui_logger_level = 1;
pub const webui_logger_level_WEBUI_LOGGER_LEVEL_ERROR: webui_logger_level = 2;
pub type webui_logger_level = ::std::os::raw::c_uint;
unsafe extern "C" {
